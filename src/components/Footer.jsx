      ...
      <div className="footer-container">
        <div className="footer-section about">
          ...
          <div className="social-icons">
            ...
            <a href="https://www.instagram.com" className="social-icon instagram" target="_blank" rel="noreferrer">
              <FaInstagram />
            </a>
            <a href="https://www.youtube.com" className="social-icon youtube" target="_blank" rel="noreferrer">
              <FaYoutube />
            </a>
